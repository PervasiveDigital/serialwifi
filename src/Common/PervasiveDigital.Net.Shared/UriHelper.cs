...
namespace PervasiveDigital
{
    internal static class UriHelper
    {
        ...
        internal static string HexEscapeMultiByte(char character)
        {
            ...
            byte[] bytes = Encoding.UTF8.GetBytes(new string(new[] {character}));
            ...
            UriFormat uriFormat, FormatFlags formatFlags)
        {
            ...
            if (c == '/' || c == '\\')
            {
                if (uriKind == UriKind.Absolute && uriFormat != UriFormat.UriEscaped &&
